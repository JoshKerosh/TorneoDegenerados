 ...
 * @author Josh
 */
public class ReiniciarEquipoCommand extends BaseCommand {
    public static final String COMMAN_NAME = "REINICIAREQUIPO";
    ...
    public void execute(String[] args, OutputStream out, ControladorTorneo controlador) { 
        if(validArgs(args,out)){
            ...
            log(message);
            controlador.modelo.getJugadorLocal().vaciarEquipo();
            write(out, "Equipo reiniciado");
        }
    }
